    ...
    return (
        <div className="hero min-h-[85vh] md:min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src={"/assets/banner.svg"} data-aos="fade-left" className="w-2/3 md:max-w-lg rounded-lg" />
                <div data-aos="fade-right">
                    ...
                    <Link href="/login" className="btn hover:bg-orange-500 text-white btn-primary bg-orange-600 border-none font-opensans">Let&rsquo;s Explore</Link>
                </div>
            </div>
        </div>
    );
